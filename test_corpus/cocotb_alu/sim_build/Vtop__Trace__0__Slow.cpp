...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    VL_TRACE_DECL_BUS(tracep,c+16,0,"WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::INT, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+10,0,"op",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 3,0);
    VL_TRACE_DECL_BUS(tracep,c+11,0,"a",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+12,0,"b",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 31,0);
    ...
    VL_TRACE_DECL_BIT(tracep,c+15,0,"overflow",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_POP_PREFIX(tracep);
}
...
VL_ATTR_COLD void Vtop___024root__trace_const_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+16,(0x00000020U),32);
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+8,(vlSelfRef.alu__DOT__clk));
    bufp->fullBit(oldp+9,(vlSelfRef.alu__DOT__rst_n));
    bufp->fullCData(oldp+10,(vlSelfRef.alu__DOT__op),4);
    bufp->fullIData(oldp+11,(vlSelfRef.alu__DOT__a),32);
    bufp->fullIData(oldp+12,(vlSelfRef.alu__DOT__b),32);
    bufp->fullIData(oldp+13,(vlSelfRef.alu__DOT__result),32);
    bufp->fullBit(oldp+14,(vlSelfRef.alu__DOT__zero));
    bufp->fullBit(oldp+15,(vlSelfRef.alu__DOT__overflow));
}
